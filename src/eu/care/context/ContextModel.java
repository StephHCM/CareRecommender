...
public class ContextModel {
	...
	public String getCurrentWeatherCondition(DemonstratorMain main, String dbName){
	...
	public String getCurrentLightConditions(DemonstratorMain main, String dbName){
		...
		try {
			...
			if ((sunrise == null || sunset == null) || diffInHours > updateIntervalSolarAltitude) {
				...
				if(!sunriseSunsetJSON.isEmpty()){
					...
					lightConditions = new TimeInterpreter().getCurrentLightConditionsOutdoors(sunrise, sunset);
